...
if __name__ == '__main__':
    ...
    with open(args.output, "w", encoding="cp1251") as val_cfg:
        ...
        val_cfg.write(f"OutputName={os.path.join(args.pred_output,os.path.splitext(os.path.basename(args.sdf))[0]+ '_' +os.path.splitext(os.path.basename(args.model))[0] + '.csv')}\n")
    print("Success")
