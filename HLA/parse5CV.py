...
'''
Скрипт делают сводку результатов 5-кратной кросс-валидации для моделей HLA. Отличие в том, что эти модели имеют 1 гиперпараметр, а не 2
